      ...
      <article className="glass-card p-8 md:p-10 xl:p-12">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-hp">
          ...
          <section>
            ...
            <p className="mt-3 text-hp-muted">
              AI 相談窓口では、契約済みワークスペース AI、ローカル AI、またはフォーム fallback を、
              案件整理と連絡補助のために利用します。AI 応答は相談補助であり、正式見積、契約成立、
              納期保証、または最終判断ではありません。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-hp-muted">
              ログインしている本人の過去 conversation、booking、reference URL のみを文脈として利用し、
              他ユーザー情報を LLM に渡しません。Google Calendar Free/Busy からは busy 時間帯のみを参照し、
              予定タイトル、参加者、場所は取得しません。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-hp-muted">
              チャットログは 30 日自動削除の対象として順次実装します。予約、問い合わせ、
