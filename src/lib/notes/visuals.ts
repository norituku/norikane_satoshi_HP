...
export const VISUAL_REGISTRY: Record<string, VisualConfig> = {
  ...
  "grading-natural-vs-normal": {
    ...
    title: "ナチュラルとノーマルは違う",
    caption:
      "ナチュラル軸 (上が高い) ／ ノーマル軸 (右が高い) の二軸を独立した 4 象限画像で対比し、左上「狙う狭い場所」を主役象限としてアクセント枠とラベル帯で強調する図。右上は「設計上の中立」、右下は「現在の感覚とずれる」、左下は「あざとい」として、4 象限すべてを 1 ラベルで整理する。",
    alt: "ナチュラル (縦軸) とノーマル (横軸) の四象限を 2×2 の独立画像で並べ、左上の狙う狭い場所を主役象限としてアクセント枠で強調し、右上に設計上の中立、右下に現在の感覚とずれる、左下にあざといを 1 ラベルで配置する静止図。",
