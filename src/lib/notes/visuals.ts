...
export const VISUAL_REGISTRY: Record<string, VisualConfig> = {
  ...
  "grading-mix-vs-split": {
    ...
    caption:
      "「しっとり感を」のオーダーに、トーンカーブを下にへこませて応えたら、狙った締まりと一緒に、前面の顔のフェイストーンまで沈んでしまった。",
    alt: "「もう少ししっとり感を」のオーダーに、トーンカーブの中央制御点を下にへこませてグラフを変形させると、参照画像の背景・暗部は狙い通り締まるが、前面の顔のフェイストーンまで一緒に沈んでしまう様子を、視線リング・参照画像・顔副作用オーバーレイ・結末ピルで示す 12 秒の 1 セル動画。",
    aspect: { width: 16, height: 5 },
    intro: "トーンカーブまるごとを下に引いた日。背景は締まったけど、顔も一緒に沈んだ。",
    loopSec: 12,
  },
}
