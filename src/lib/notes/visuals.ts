...
export const VISUAL_REGISTRY: Record<string, VisualConfig> = {
  ...
  "grading-mix-vs-split": {
    ...
    caption:
      "軸の枠組みが頭にないと、暖色を 1 段足したつもりが、別の何かも勝手にズレている。本人はそれに気づかない。",
    alt: "無名の LUT 箱に『暖かく』のオーダーを入れると、無名のメーター 4 本のうち本人が触った 1 本だけでなく、他 3 本も勝手に振れ、絵プレビューも本人の意図と違う方向にズレる。本人はそれに気づかないまま画面から退場する 12 秒の 1 セル動画。",
    aspect: { width: 16, height: 5 },
    intro: "分けられない道具で 1 つだけ動かそうとしても、隣がついてくる。",
    loopSec: 12,
  },
}
